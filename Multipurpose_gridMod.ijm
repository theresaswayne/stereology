...
*/
/*
This version is modified to be recordable in the ImageJ1 macro language.
Macro recording requires the first word of each dialog option to be unique.
To make the command recordable, underscores were added to some parameter names.
Theresa Swayne, tcs6@cumc.columbia.edu, 2016
*/
